...
function FeedbackForm() {
    ...
    const feedback_type = {
        'qos': 'How often do you find the recommended movies to be a good fit for your taste?', 
        'qob': 'In your opinion, how well does the recommendation system understand your movie preferences? ',
        'roc': 'How satisfied are you with the variety of movies the system recommends?',
        'exp': 'Please rate your overall movie experience.'
    };
